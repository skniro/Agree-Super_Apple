...
public class AgreeHoeItem
     ...
     */
    protected static final Map<Block, Pair<Predicate<ItemUsageContext>, Consumer<ItemUsageContext>>> TILLING_ACTIONS = Maps.newHashMap(ImmutableMap.of(Blocks.GRASS_BLOCK, Pair.of(net.minecraft.item.HoeItem::canTillFarmland, net.minecraft.item.HoeItem.createTillAction(Blocks.FARMLAND.getDefaultState())), Blocks.DIRT_PATH, Pair.of(net.minecraft.item.HoeItem::canTillFarmland, net.minecraft.item.HoeItem.createTillAction(Blocks.FARMLAND.getDefaultState())), Blocks.DIRT, Pair.of(net.minecraft.item.HoeItem::canTillFarmland, net.minecraft.item.HoeItem.createTillAction(Blocks.FARMLAND.getDefaultState())), Blocks.COARSE_DIRT, Pair.of(net.minecraft.item.HoeItem::canTillFarmland, net.minecraft.item.HoeItem.createTillAction(Blocks.DIRT.getDefaultState())), Blocks.ROOTED_DIRT, Pair.of(itemUsageContext -> true, net.minecraft.item.HoeItem.createTillAndDropAction(Blocks.DIRT.getDefaultState(), Items.HANGING_ROOTS))));

    public AgreeHoeItem(ToolMaterial material, int attackDamage, float attackSpeed, Item.Settings settings) {
