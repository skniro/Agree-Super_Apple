        ...
        LootTableLoadingCallback.EVENT.register((resourceManager, lootManager, id, tableBuilder, source) -> {
            if(IGLOO_STRUCTURE_CHEST_ID.equals(id)) {
                FabricLootPoolBuilder poolBuilder = FabricLootPoolBuilder.builder()
                        ...
                        .withCondition(RandomChanceLootCondition.builder(0.15f)) // Drops 15% of the time
                        .withEntry(ItemEntry.builder(AppleFoodComponents.SUPER_APPLE))
                ...
                FabricLootPoolBuilder poolBuilder2 = FabricLootPoolBuilder.builder()
                        .withRolls(ConstantLootTableRange.create(1))
                        .withCondition(RandomChanceLootCondition.builder(0.35f)) // Drops 35% of the time
                        .withEntry(ItemEntry.builder(AppleFoodComponents.HASTE_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.STRENGTH_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.FIRE_RESISTANCE_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.HEALTH_BOOST_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.HERO_VILLAGE_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.JUMP_BOOST_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.NIGHT_VISION_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.SPEED_APPLE))
            ...
            if(Mineshaft_STRUCTURE_CHEST_ID.equals(id)) {
                FabricLootPoolBuilder poolBuilder = FabricLootPoolBuilder.builder()
                        .withRolls(ConstantLootTableRange.create(1))
                        .withCondition(RandomChanceLootCondition.builder(0.05f)) // Drops 35% of the time
                        .withEntry(ItemEntry.builder(AppleFoodComponents.SUPER_APPLE))
                        .withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(1.0f, 1.0f)));
                tableBuilder.withPool(poolBuilder);
                FabricLootPoolBuilder poolBuilder2 = FabricLootPoolBuilder.builder()
                        .withRolls(ConstantLootTableRange.create(1))
                        .withCondition(RandomChanceLootCondition.builder(0.15f)) // Drops 35% of the time
                        .withEntry(ItemEntry.builder(AppleFoodComponents.HASTE_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.STRENGTH_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.FIRE_RESISTANCE_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.HEALTH_BOOST_APPLE))
            ...
            if(Ancient_City_CHEST_ID.equals(id)) {
                ...
                FabricLootPoolBuilder poolBuilder2 = FabricLootPoolBuilder.builder()
                        .withRolls(ConstantLootTableRange.create(1))
                        .withCondition(RandomChanceLootCondition.builder(0.55f)) // Drops 35% of the time
                        .withEntry(ItemEntry.builder(AppleFoodComponents.HASTE_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.STRENGTH_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.FIRE_RESISTANCE_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.HEALTH_BOOST_APPLE))
            ...
            if(Bastion_Hoglin_Stable_CHEST_ID.equals(id)) {
                ...
                FabricLootPoolBuilder poolBuilder2 = FabricLootPoolBuilder.builder()
                        .withRolls(ConstantLootTableRange.create(1))
                        .withCondition(RandomChanceLootCondition.builder(0.25f)) // Drops 35% of the time
                        .withEntry(ItemEntry.builder(AppleFoodComponents.HASTE_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.STRENGTH_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.FIRE_RESISTANCE_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.HEALTH_BOOST_APPLE))
            ...
            if(End_City_Treasure_CHEST_ID.equals(id)) {
                ...
                FabricLootPoolBuilder poolBuilder2 = FabricLootPoolBuilder.builder()
                        .withRolls(ConstantLootTableRange.create(1))
                        .withCondition(RandomChanceLootCondition.builder(0.45f)) // Drops 35% of the time
                        .withEntry(ItemEntry.builder(AppleFoodComponents.HASTE_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.STRENGTH_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.FIRE_RESISTANCE_APPLE))
                        .withEntry(ItemEntry.builder(AppleFoodComponents.HEALTH_BOOST_APPLE))
            ...
            if(Desert_Pyramid_ID.equals(id)) {
                FabricLootPoolBuilder poolBuilder = FabricLootPoolBuilder.builder()
                        .withRolls(ConstantLootTableRange.create(1))
                        .withCondition(RandomChanceLootCondition.builder(0.10f)) // Drops 35% of the time
                        .withEntry(ItemEntry.builder(AppleFoodComponents.SUPER_APPLE))
                        .withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(1.0f, 1.0f)));
                tableBuilder.withPool(poolBuilder);
                FabricLootPoolBuilder poolBuilder2 = FabricLootPoolBuilder.builder()
            ...
            if(Stronghold_Crossing_CHEST_ID.equals(id)) {
                FabricLootPoolBuilder poolBuilder = FabricLootPoolBuilder.builder()
                        .withRolls(ConstantLootTableRange.create(1))
                        .withCondition(RandomChanceLootCondition.builder(0.1f)) // Drops 35% of the time
                        .withEntry(ItemEntry.builder(AppleFoodComponents.SUPER_APPLE))
                        .withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(1.0f, 1.0f)));
                tableBuilder.withPool(poolBuilder);
                FabricLootPoolBuilder poolBuilder2 = FabricLootPoolBuilder.builder()
