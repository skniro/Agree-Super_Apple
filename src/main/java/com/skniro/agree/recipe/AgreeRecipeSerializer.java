...
public class AgreeRecipeSerializer{
    ...
    public static final RegistryObject<SimpleCraftingRecipeSerializer<SuspiciousAppleRecipe>> SUSPICIOUS_APPLE =
            RECIPE_SERIALIZER.register("crafting_special_suspiciousapple",
                    ()-> new SimpleCraftingRecipeSerializer<SuspiciousAppleRecipe>(SuspiciousAppleRecipe::new));
