...
public class AgreeBlocks {
    ...
    public static final Block HASTE_APPLE_LEAVES =registerBlock("haste_apple_leave",
            (settings)-> new LeafCropBlock(settings, AppleFoodComponents.HASTE_APPLE), BlockBehaviour.Properties.of().noOcclusion().mapColor(MapColor.NETHER));
    public static final Block SPEED_APPLE_LEAVES =registerBlock("speed_apple_leave",
            (settings)-> new LeafCropBlock(settings, AppleFoodComponents.SPEED_APPLE), BlockBehaviour.Properties.of().noOcclusion().mapColor(MapColor.NETHER));
    public static final Block HEALTH_BOOST_LEAVES =registerBlock("health_boost_leave",
            (settings)-> new LeafCropBlock(settings, AppleFoodComponents.HEALTH_BOOST_APPLE), BlockBehaviour.Properties.of().noOcclusion().mapColor(MapColor.NETHER));
    public static final Block FIRE_RESISTANCE_LEAVES =registerBlock("fire_resistance_leave",
            (settings)-> new LeafCropBlock(settings, AppleFoodComponents.FIRE_RESISTANCE_APPLE), BlockBehaviour.Properties.of().noOcclusion().mapColor(MapColor.NETHER));
    public static final Block HERO_VILLAGE_LEAVES =registerBlock("village_hero_leave",
            (settings)-> new LeafCropBlock(settings, AppleFoodComponents.HERO_VILLAGE_APPLE), BlockBehaviour.Properties.of().noOcclusion().mapColor(MapColor.NETHER));
    public static final Block STRENGTH_LEAVES =registerBlock("strength_apple_leave",
            (settings)-> new LeafCropBlock(settings, AppleFoodComponents.STRENGTH_APPLE), BlockBehaviour.Properties.of().noOcclusion().mapColor(MapColor.NETHER));
    public static final Block NIGHT_VISION_LEAVES =registerBlock("night_vision_leave",
            (settings)-> new LeafCropBlock(settings, AppleFoodComponents.NIGHT_VISION_APPLE), BlockBehaviour.Properties.of().noOcclusion().mapColor(MapColor.NETHER));
    public static final Block JUMP_BOOST_LEAVES =registerBlock("jump_boost_leave",
            (settings)-> new LeafCropBlock(settings, AppleFoodComponents.JUMP_BOOST_APPLE), BlockBehaviour.Properties.of().noOcclusion().mapColor(MapColor.NETHER));
    ...
    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(BuiltInRegistries.ITEM, ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Agree.MOD_ID, name)),
                new BlockItem(block, new Item.Properties().useBlockDescriptionPrefix()
                        .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Agree.MOD_ID, name)))));
    }
    ...
    private static ResourceKey<Block> keyOf(String name) {
        return ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(Agree.MOD_ID, name));
    }
