...
public class OreBiomeModifications
{
    public static void addOres()
    {
        ...
        // Inject into Biomes
        BiomeModifications.addFeature(overworldSelector(), GenerationStep.Decoration.UNDERGROUND_ORES, ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(Agree.MOD_ID, "ore_ruby_overworld")));
    }
